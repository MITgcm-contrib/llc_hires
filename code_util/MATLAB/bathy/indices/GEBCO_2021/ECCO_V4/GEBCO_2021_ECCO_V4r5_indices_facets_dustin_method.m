...
dataDir1 = '/Users/carrolld/Documents/research/bathy/mat/cell_corners/ECCO_V4r5/';
...
for i = 1:numFacets
    ...
    for j = 1:m
        ...
        for k = 1:n
            ...
            if (numDryCells >= (numTotalCells .* 0.9))
                ...
                bathy.ECCO_V4r5_ind{c} = [j k]; %LLC 270 index
    ...
    save([saveDir 'GEBCO_2021_ECCO_V4r5_indices_facet_' num2str(i) '_' suffix  '.mat'],'bathy','-v7.3');
