...
dataDir1 = '/Users/carrolld/Documents/research/LLC_540/mat/cell_corners/LLC_270/';
dataDir2 = '/Users/carrolld/Documents/research/LLC_540/mat/GEBCO_2021/LLC_270/';
dataDir3 = '/Users/carrolld/Documents/research/LLC_540/raw_data/GEBCO_2021/';

saveDir = '/Users/carrolld/Documents/research/LLC_540/mat/GEBCO_2021/LLC_270/';

%%

load([dataDir1 'cell_corners_facets_LLC_270.mat']);
...
GEBCO = load([dataDir2 'GEBCO_2021_lon_lat.mat']);
...
for i = 1:numFacets
    ...
    save([saveDir 'GEBCO_2021_LLC_270_indices_facet_' num2str(i) '_' suffix  '.mat'],'bathy','-v7.3');
