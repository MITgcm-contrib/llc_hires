...
####BUILD####
  ...
  cp ../../llc_hires/trillium/llc_4320/code-async/SIZE.h_120x120x16848 SIZE.h
...
#  cp ../../llc_hires/trillium/llc_1080/code-async/SIZE.h_20x20x37908 SIZE.h
  ...
  -mods '../../llc_hires/trillium/llc_4320/code-async
  ../../llc_hires/trillium/llc_4320/code'
  make depend
  make -j 64

####RUN####
  cd $SCRATCH/MITgcm/run_LPNB
  cp ../build/mitgcmuv mitgcmuv_120x120x16848
...
#  cp -f data.exch2_90x54x2229 data.exch2
 ...
 unset I_MPI_PMI_LIBRARY
  mpiexec -n 17280 ./mitgcmuv_120x120x16848
